...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if (Validation.ValidateEmail(email) == true && Validation.ValidateNumber(contact) == true) {
				...
				if(i > 0) {
					...
					JOptionPane.showMessageDialog(LibrarianForm.this,"Sorry, unable to save data!");
				}
			}
			else if (Validation.ValidateEmail(email) != true && Validation.ValidateNumber(contact) == true) {
				JOptionPane.showMessageDialog(LibrarianForm.this,"Please re-enter a valid E-Mail ID.");
			}
			else if (Validation.ValidateEmail(email) == true && Validation.ValidateNumber(contact) != true) {
				JOptionPane.showMessageDialog(LibrarianForm.this,"Please re-enter a valid contact number.");
			}
			else if (Validation.ValidateEmail(email) != true && Validation.ValidateNumber(contact) != true) {
				JOptionPane.showMessageDialog(LibrarianForm.this,"Please re-enter a valid E-Mail ID and contact number.");
			}
			}
		});
