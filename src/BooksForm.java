...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		textField.setText(randomize.randomizeCallNo());
		...
		btnAddBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String quantityString = textField_4.getText();
				if (callno == null || name == null || author == null || publisher == null || quantityString == null) {
					...
					JOptionPane.showMessageDialog(BooksForm.this, "Please fill out empty fields!");
				}
